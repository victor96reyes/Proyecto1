...
class VehiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehiculo" do
    assert_difference('Vehiculo.count') do
      post vehiculos_url, params: { vehiculo: { anyofabric: @vehiculo.anyofabric, cantpasj: @vehiculo.cantpasj, cilindraje: @vehiculo.cilindraje, foto: @vehiculo.foto, marca: @vehiculo.marca, modelo: @vehiculo.modelo, motor: @vehiculo.motor } }
    end
  ...
  test "should update vehiculo" do
    patch vehiculo_url(@vehiculo), params: { vehiculo: { anyofabric: @vehiculo.anyofabric, cantpasj: @vehiculo.cantpasj, cilindraje: @vehiculo.cilindraje, foto: @vehiculo.foto, marca: @vehiculo.marca, modelo: @vehiculo.modelo, motor: @vehiculo.motor } }
